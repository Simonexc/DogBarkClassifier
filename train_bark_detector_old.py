...
CHECKPOINT_DIR = Path("checkpoints_bark_detector_2d_v23")  # New dir for 2D model checkpoints
...
# --- Augmentations ---
# Note: TimeStretch changes duration, needs handling in Dataset
augment = Compose([
...
if __name__ == "__main__":
    ...
    model = SpectrogramCNN(num_classes=1).to(DEVICE)
    ...
    best_model = SpectrogramCNN(num_classes=1).to(DEVICE)
